<?php
//------------------------------------------------------------
//-- Time Zone Clock Version 4.1 (Feb 26, 2013)           --
//------------------------------------------------------------

/**
* @ Copyright (C) 2013 Advance Language Alliance
...
var spantxt2="<span style=\'margin: 0px 7px 0px 0px;padding:0px 2px 0px 2px;'.$borderstr.' background:'.$bgcolor.'; vertical-align:middle; width:auto; align=left\'>";
...
if($Zone1<>"" and !$Display){
      $content.='<div id="RC1"></div>';}
if($Zone2<>"" and !$Display){
      $content.='<div id="RC2"></div>';}
if($Zone3<>"" and !$Display){
      $content.='<div id="RC3"></div>';}
if($Zone4<>"" and !$Display){
      $content.='<div id="RC4"></div>';}
if($Zone5<>"" and !$Display){
      $content.='<div id="RC5" ></div>';}
if($Zone6<>"" and !$Display){
      $content.='<div id="RC6"></div>';}
if($Zone7<>"" and !$Display){
      $content.='<div id="RC7"></div>';}
if($Zone8<>"" and !$Display){
      $content.='<div id="RC8"></div>';}
if($Zone9<>"" and !$Display){
      $content.='<div id="RC9"></div>';}
if($Zone10<>"" and !$Display){
      $content.='<div id="RC10" ></div>';}
if($Zone1<>"" and $Display){
      $content.='<span id="RC1" ></span>';}
if($Zone2<>"" and $Display){
      $content.='<span id="RC2" ></span>';}
if($Zone3<>"" and $Display){
      $content.='<span id="RC3" ></span>';}
if($Zone4<>"" and $Display){
      $content.='<span id="RC4" ></span>';}
if($Zone5<>"" and $Display){
      $content.='<span id="RC5" ></span>';}
if($Zone6<>"" and $Display){
      $content.='<span id="RC6" ></span>';}
if($Zone7<>"" and $Display){
      $content.='<span id="RC7" ></span>';}
if($Zone8<>"" and $Display){
      $content.='<span id="RC8" ></span>';}
if($Zone9<>"" and $Display){
      $content.='<span id="RC9" ></span>';}
if($Zone10<>"" and $Display){
      $content.='<span id="RC10" ></span>';}
$content.='</div>';
